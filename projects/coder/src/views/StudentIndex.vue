      ...
      <el-col :span="12" class="navBox">
        ...
        >
          ...
          <el-menu-item index="1" @click="borrow()">
            ...
            <span slot="title">AtCoder比赛数据</span>
          </el-menu-item>
          <el-menu-item index="2" @click="codeforces()">
            <i class="iconfont icon-sousuo2"></i>
            <span slot="title">Codeforces比赛数据</span>
          </el-menu-item>
          <el-menu-item index="3" @click="stuInfo()">
            <i class="iconfont icon-geren3"></i>
            <span slot="title">学生基本信息</span>
          </el-menu-item>
          <el-menu-item index="4" @click="competition()">
            <i class="iconfont icon-sousuo2"></i>
...
export default {
  ...
  methods: {
    ...
    codeforces () {
      if (this.$route.name !== 'Codeforces') {
        this.$router.replace({ path: '/Codeforces' })
      }
    },
    competition () {
